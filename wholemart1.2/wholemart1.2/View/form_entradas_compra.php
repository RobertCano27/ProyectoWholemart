...
<body>
    ...
    ?>
        ...
        $sql = "SELECT  compra.ENTRADA_COMPRA_FECHA, compra.ENTRADA_COMPRA_CANTIDAD, 
        prod.PRODUCTO_NOMBRE_PRODUCTO,prod.PRODUCTO_DESCRIPCION_PRODUCTO,prod.PRODUCTO_VALOR_UNITARIO_COMPRA,
        prov.PROVEEDOR_NOMBRE 
        FROM `entrada_compra` compra
        LEFT JOIN proveedor prov ON (compra.ENTRADA_COMPRA_ID_PROVEEDOR= prov.ID_PROVEEDOR)
        LEFT JOIN producto prod ON (compra.ENTRADA_COMPRA_ID_PRODUCTO= prod.ID_PRODUCTO)";
            ...
            <nav class="navbar bg-body-tertiary" style="background-color: #8c6e8c;">
                <div class="container-fluid">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a href="entradas.php"><button class="btn me-md-2" style="background-color: #f7d6f2;" type="button">REGISTRAR NUEVA COMPRA</button></a>
            ...
            <div class="container-5">
                <table class="table table-dark table-striped-columns">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <td> <?php echo $row['ENTRADA_COMPRA_FECHA'] ?> </td>
                                <td> <?php echo $row['ENTRADA_COMPRA_CANTIDAD'] ?></td>
                                <td> <?php echo $row['PRODUCTO_NOMBRE_PRODUCTO'] ?></td>
                                <td> <?php echo $row['PRODUCTO_DESCRIPCION_PRODUCTO'] ?></td>
                                <td> <?php echo $row['PRODUCTO_VALOR_UNITARIO_COMPRA'] ?></td>
