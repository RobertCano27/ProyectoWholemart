...
<body>
    ...
    ?>
        ...
        $sql = "SELECT `ID_USUARIO`, `USUARIO_TIPO_DOCUMENTO`, `USUARIO_NUMERO_DOCUMENTO`, `USUARIO_NOMBRE`, `USUARIO_APELLIDO`, `USUARIO_CORREO_ELECTRONICO`, `USUARIO_CONTRASENA`, `USUARIO_ID_ESTADO`, `USUARIO_ID_ROL` FROM `usuario`";
        ...
        <div class="container mt-5">
            <nav class="navbar bg-body-tertiary" style="background-color: #8c6e8c;">
                <div class="container-fluid">
                    ...
                    <a href="registrar_usuario.php"><button class="btn btn-success me-md-2" style="background-color: #9d067a;" type="button">INGRESAR NUEVO USUARIO</button></a>
            ...
            <div class="container-5">
                <table class="table table-dark table-striped-columns">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <td> <?php echo $row['USUARIO_TIPO_DOCUMENTO'] ?> </td>
                                <td> <?php echo $row['USUARIO_NUMERO_DOCUMENTO'] ?></td>
                                <td> <?php echo $row['USUARIO_NOMBRE'] ?></td>
                                <td> <?php echo $row['USUARIO_APELLIDO'] ?></td>
                                <td> <?php echo $row['USUARIO_CORREO_ELECTRONICO'] ?></td>
                                <td> <?php echo $row['USUARIO_ID_ROL'] ?></td>
