            ...
            <nav class="navbar bg-body-tertiary" style="background-color: #8c6e8c;">
                <div class="container-fluid">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a href="registrar_producto.php"><button class="btn me-md-2" style="background-color: #f7d6f2;" type="button">REGISTRAR PRODUCTO</button></a>
                ...
                <table class="table table-dark table-striped-columns">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">VALOR UNITARIO DE COMPRA</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td> <?php echo $row['PRODUCTO_ID_ESTADO'] ?></td>
