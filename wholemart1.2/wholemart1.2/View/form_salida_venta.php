...
<body>
    ...
    ?>
        ...
        $sql = "SELECT ven.ID_VENTA, ven.VENTA_ID_PRODUCTO, prod.PRODUCTO_NOMBRE_PRODUCTO, ven.CANTIDAD_VENDIDA, ven.VALOR_UNITARIO, ven.VALOR_TOTAL, ven.VENTA_FECHA_VENTA, cl.CLIENTE_NUMERO_DOCUMENTO,   cl.CLIENTE_NOMBRE, us.USUARIO_NOMBRE  FROM `venta` ven
        INNER JOIN producto prod ON(ven.VENTA_ID_PRODUCTO = prod.ID_PRODUCTO)
        INNER JOIN clientes cl ON (ven.VENTA_ID_CLIENTE = cl.ID_CLIENTE)
        INNER JOIN usuario us ON(ven.VENTA_ID_USUARIO = us.ID_USUARIO)";
            ...
            <nav class="navbar bg-body-tertiary" style="background-color: #8c6e8c;">
                <div class="container-fluid">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a href="salidas.php"><button class="btn me-md-2" style="background-color: #f7d6f2;" type="button">REGISTRAR NUEVA VENTA</button></a>
                        <a href="bodega.php"><button class="btn btn-success me-md-2" style="background-color: #9d067a;"  type="button">VOLVER</button></a>
                    </div>
